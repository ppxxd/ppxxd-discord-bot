...
let embed = new Discord.RichEmbed()
    ...
    embed.setAuthor(`Информация о сервере`, sicon)
    embed.setTimestamp()
    ...
    embed.addField('Кол-во каналов:', message.guild.channels.size, true)
    embed.addField('Кол-во ролей:', message.guild.roles.size, true) 
    embed.addField("Кол-во участников:", message.guild.memberCount, true)
    embed.addField("Кол-во ботов:", message.guild.members.filter(m => m.user.bot).size, true)
